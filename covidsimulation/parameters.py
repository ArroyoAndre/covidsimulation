...
class Parameters:
    ...
    street_transmission_scale_days: float = DEFAULT_STREET_TRANSMISSION_SCALE_DAYS
    social_group_transmission_scale_days: float = DEFAULT_SOCIAL_GROUP_TRANSMISSION_SCALE_DAYS
